...
<body>
    ...
    <div class="main-body">
    <div class="col-sm-10" style="position:relative; left:10%;">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10" style="position:relative; left:40px;">
          <form  role="form" action="/diop/index.php" method="POST" >
              
                
                <label><b>Login</b></label>
                <input type="text"  id="login" placeholder="Entrer le nom d'utilisateur" name="login" required>
